...
summary: 'Habilite o SSH no switch de cluster Broadcom BES-53248 para suportar os recursos de monitor de integridade do switch Ethernet (CSHM) e de coleta de logs.' 
---
= Habilite o SSH no switch de cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Habilite o SSH no switch de cluster Broadcom BES-53248 para suportar os recursos de monitor de integridade do switch Ethernet (CSHM) e coleta de logs. Este procedimento abrange a geração de chaves SSH e a ativação do acesso SSH no switch.
