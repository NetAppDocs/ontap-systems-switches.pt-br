...
summary: Migre de uma rede de cluster com switches Broadcom BES-53248 para uma configuração de cluster sem switch de dois nós para ONTAP 9.3 e versões posteriores. 
---
= Migre de switches de cluster Broadcom BES-53248 para conexões sem switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
