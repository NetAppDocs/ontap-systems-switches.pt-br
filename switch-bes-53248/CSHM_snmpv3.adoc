...
summary: 'Configure o SNMPv3 no switch de cluster Broadcom BES-53248 para habilitar a comunicação segura com o monitor de integridade do switch Ethernet (CSHM).' 
---
= Configurar o SNMPv3 para o switch de cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Configure o SNMPv3 no switch de cluster Broadcom BES-53248 para habilitar a comunicação segura e autenticada com o monitor de integridade do switch Ethernet (CSHM). O SNMPv3 fornece sondagem criptografada do status do switch para monitoramento de integridade no ONTAP.
