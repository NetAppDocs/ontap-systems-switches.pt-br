...
summary: Siga este fluxo de trabalho para instalar e configurar um novo switch de cluster Broadcom BES-53248, desde a revisão dos requisitos até a configuração de hardware e software. 
---
= Fluxo de trabalho de instalação e configuração para o switch de cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar e configurar um novo switch de cluster Broadcom BES-53248 em um ambiente ONTAP. O BES-53248 é um switch bare metal que suporta clusters ONTAP de dois a 24 nós.
...
[role="quick-margin-para"]
Configurar o monitoramento de integridade do switch Ethernet.
