...
---
= Instale o arquivo de configuração de referência (RCF) e o arquivo de licença.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partir da versão 3.12.0.1 do EFOS, é possível instalar o Arquivo de Configuração de Referência (RCF) e o arquivo de licença após configurar o switch de cluster BES-53248.
...
* O RCF atual, disponível em https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Comutadores de cluster Broadcom"^] página.
