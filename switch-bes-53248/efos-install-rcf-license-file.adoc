...
---
= Instale o arquivo de configuração (RCF) e o arquivo de licença
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partir do EFOS 3.12.0.1, é possível instalar o arquivo RCF e o arquivo de licença após configurar o switch de cluster BES-53248.
