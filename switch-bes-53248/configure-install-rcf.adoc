...
summary: Você pode instalar o Arquivo de Configuração de Referência RCF após configurar o switch de cluster BES-53248 e após aplicar as novas licenças. 
---
= Instale o arquivo de configuração (RCF)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode instalar o RCF após configurar o switch de cluster BES-53248 e após aplicar as novas licenças.
