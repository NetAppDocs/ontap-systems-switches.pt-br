...
summary: 'Atualize o arquivo de configuração de referência (RCF) no switch de cluster Broadcom BES-53248 após atualizar o software EFOS.' 
---
= Atualize o RCF no switch de cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração de referência (RCF) no switch de cluster Broadcom BES-53248 após atualizar o software EFOS e aplicar as licenças necessárias.
...
* É necessária uma conexão de console com o switch ao instalar o RCF a partir de suas configurações de fábrica.
...
Você utiliza a CLI do switch e a CLI do ONTAP (conforme indicado nas etapas a seguir) para configurações de portas. Você configura as portas no primeiro switch (cs2) e depois repete essas etapas para o segundo switch (cs1).
...
CAUTION: Ao atualizar ou aplicar um novo RCF, você deve apagar as configurações do switch e realizar a configuração básica. Você deve estar conectado ao switch usando o console serial para apagar as configurações do switch.
...
[listing, subs="+quotes"]
----
(cs2)# *copy sftp://172.19.2.1/BES-53248_RCF_v1.9-Cluster-HA.txt nvram:reference-config*
Remote Password:**
Mode........................................... SFTP
...
nvram:script BES-53248_RCF_v1.9-Cluster-HA*
Remote Password:**
Mode........................................... SFTP
Set Server IP.................................. 172.19.2.1
Path........................................... //tmp/
...
--
====
. [[passo20]]Repita os passos 1 a 19 no switch cs1.
...
--
====
. [[passo 6]] Altere o nível de privilégio de volta para admin:
+
[source, cli]
----
set -privilege admin
...
.O que vem a seguir?
Após atualizar seu RCF, você pode link:configure-ssh.html["Habilite SSH para coleta de logs"].
