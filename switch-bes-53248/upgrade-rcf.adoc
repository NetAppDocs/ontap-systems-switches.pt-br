...
summary: 'Você pode atualizar o Arquivo de Configuração de Referência (RCF) após configurar o switch de cluster BES-53248 e após aplicar quaisquer novas licenças.' 
---
= Atualize o arquivo de configuração de referência (RCF)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode atualizar o Arquivo de Configuração de Referência (RCF) após atualizar o switch de cluster BES-53248 EFOS e após aplicar quaisquer novas licenças.
...
* Consulte os guias de software e atualização apropriados disponíveis em https://www.broadcom.com/support/bes-switch["Broadcom"^] Site para obter documentação completa sobre os procedimentos de atualização e downgrade do switch BES-53248.
...
. Observe o seguinte:
+
.. Caso licenças de porta adicionais tenham sido instaladas no switch, você deverá modificar o RCF para configurar as portas licenciadas adicionais. Ver link:configure-licenses.html#activate-newly-licensed-ports["Ativar portas recém-licenciadas"] Para mais detalhes. No entanto, quando você atualiza para RCF 1.12 ou posterior, as modificações não são mais necessárias porque todas as interfaces agora estão pré-configuradas.
