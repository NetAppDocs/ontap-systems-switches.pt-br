...
summary: Siga este fluxo de trabalho para instalar o software NX-OS e o RCF em um switch compartilhado Cisco Nexus 9336C-FX2. 
---
...
[role="lead"]
Siga este fluxo de trabalho para instalar o software NX-OS e o arquivo de configuração (RCF) em um switch compartilhado Cisco Nexus 9336C-FX2.
