...
keywords:  
summary: Substitua um switch compartilhado Cisco Nexus 9336C-FX2 defeituoso. Este é um procedimento não disruptivo. 
---
...
[role="lead"]
Substitua um switch compartilhado Cisco Nexus 9336C-FX2 defeituoso sem interromper a operação do cluster ou da rede de storage. Este procedimento não disruptivo (NDU) envolve preparar um switch de substituição e restaurar a configuração do switch compartilhado.
