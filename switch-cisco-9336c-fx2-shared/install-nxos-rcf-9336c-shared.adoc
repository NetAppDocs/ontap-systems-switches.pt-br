...
[role="lead"]
Você pode instalar o arquivo de configuração de referência (RCF) depois de configurar o switch Nexus 9336C-FX2 pela primeira vez.
...
* As ligações entre interrutores (ISL) entre os interrutores estão ligadas.
...
.O que se segue?
Após instalar o RCF, você pode link:../switch-cshm/config-overview.html["Configurar o monitoramento de integridade do switch"].
