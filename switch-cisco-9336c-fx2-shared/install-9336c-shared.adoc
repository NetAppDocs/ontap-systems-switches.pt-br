...
+
Consulte o https://docs.netapp.com/platstor/topic/com.netapp.doc.hw-sw-9336c-install-cabinet/GUID-92287262-E7A6-4A62-B159-7F148097B33B.html["Instruções de estantes"] para saber como colocar o switch em rack em um gabinete NetApp.
