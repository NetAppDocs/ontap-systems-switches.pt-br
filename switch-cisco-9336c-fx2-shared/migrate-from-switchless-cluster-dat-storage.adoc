...
keywords:  
summary: Migre de um cluster sem switch com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2, adicionando dois novos switches compartilhados. 
---
= Migre de um cluster sem switch com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Migre de um cluster sem switch com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2, adicionando dois novos switches compartilhados.
...
A maioria dos sistemas requer duas portas de rede dedicadas para cluster em cada controlador. Consulte link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet da Cisco"^] para mais informações.
...
* As portas de cluster usadas neste procedimento são _e3a_ e _e3b_, conforme o controlador AFF A400. O link:https://hwu.netapp.com["Hardware Universe"^] contém as informações mais recentes sobre as portas de cluster reais para suas plataformas.
...
+
O link:https://hwu.netapp.com["Hardware Universe"^] contém mais informações sobre cabeamento. Consulte link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Que informações adicionais preciso para instalar meu equipamento que não está no HWU?"^] para obter mais informações sobre os requisitos de instalação do switch.
