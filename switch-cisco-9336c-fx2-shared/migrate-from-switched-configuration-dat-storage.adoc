...
keywords:  
summary: Migre de uma configuração comutada com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2 adicionando dois novos switches compartilhados. 
---
= Migre de uma configuração comutada com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Migre de uma configuração comutada com storage conectado diretamente para switches compartilhados Cisco Nexus 9336C-FX2 adicionando dois novos switches compartilhados.
...
As versões do ONTAP e do NX-OS suportadas neste procedimento estão na página Cisco Ethernet Switches. Consulte  https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switches Ethernet da Cisco"^].
...
O link:https://hwu.netapp.com["Hardware Universe"^]documento contém informações sobre a cablagem suportada para todos os switches de cluster.
