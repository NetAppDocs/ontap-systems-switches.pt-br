...
summary: Instale o software NX-OS em um switch compartilhado Cisco Nexus 9336C-FX2 para prepará-lo para operação de cluster compartilhado e storage. 
---
= Instale o software NX-OS em um switch compartilhado Cisco Nexus 9336C-FX2.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o software NX-OS em um switch compartilhado Cisco Nexus 9336C-FX2 para prepará-lo para operação de cluster compartilhado e storage.
