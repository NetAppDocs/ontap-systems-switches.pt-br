...
summary: Você pode instalar o RCF após configurar o switch de armazenamento Nexus 9336C-FX2 pela primeira vez. Você também pode usar este procedimento para atualizar sua versão do RCF. 
---
= Instale o arquivo de configuração de referência.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
