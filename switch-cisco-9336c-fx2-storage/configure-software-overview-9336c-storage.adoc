...
summary: Siga este fluxo de trabalho para instalar o software NX-OS e o RCF nos switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T. 
---
= Fluxo de trabalho de instalação de software para switches de storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar o software NX-OS e o arquivo de configuração (RCF) nos switches de storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Um"]link:setup-switch-9336c-storage.html["Configure o interruptor"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatro"]link:install-upgrade-rcf-overview-9336c-storage.html["Instale ou atualize o RCF"]
[role="quick-margin-para"]
