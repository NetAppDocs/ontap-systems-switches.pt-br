...
summary: Visão geral da configuração de software para switches de armazenamento Cisco Nexus 9336C-FX2 
---
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Seis"]link:reset-switch-9336c-storage.html["Restaure as configurações de fábrica do switch."]
[role="quick-margin-para"]
