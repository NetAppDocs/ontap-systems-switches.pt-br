...
summary: 'Atualize o arquivo de configuração de referência (RCF) nos switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando uma versão mais recente estiver disponível.' 
---
= Atualize o RCF nos switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração (RCF) nos switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando uma versão mais recente do RCF estiver disponível.
...
. Verifique se as portas do switch conectadas às portas de storage do nó e às portas do shelf de storage estão *up*.
+
[source, cli]
----
