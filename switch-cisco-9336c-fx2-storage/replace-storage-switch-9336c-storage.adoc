...
summary: Substitua um switch de armazenamento Cisco Nexus 9336C-FX2 ou 9336C-FX2-T defeituoso em uma rede de storage. Este é um procedimento não disruptivo. 
---
...
[role="lead"]
Substitua um switch de armazenamento Cisco Nexus 9336C-FX2 ou 9336C-FX2-T defeituoso em uma rede de storage sem interromper a operação da rede de storage. Este procedimento não disruptivo (NDU) envolve preparar um switch de substituição e restaurar a configuração da rede de storage.
