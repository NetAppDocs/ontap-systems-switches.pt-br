...
summary: Verifique se o SSH e as chaves SSH estão habilitados nos switches de armazenamento Cisco Nexus 9336C-FX2 para suportar CSHM e a coleta de logs. 
---
= Verifique a configuração SSH para os switches de storage Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique se o SSH e as chaves SSH estão habilitados nos switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T para suportar os recursos de monitor de integridade do switch Ethernet (CSHM) e coleta de logs.
...
IMPORTANT: Ao habilitar o FIPS, você deve alterar a contagem de bits para 256 no switch usando o comando `ssh key ecdsa 256 force`. Consulte link:https://docs.netapp.com/us-en/ontap/networking/configure_network_security_using_federal_information_processing_standards_@fips@.html#enable-fips["Configure a segurança de rede usando FIPS."^] para mais detalhes.
