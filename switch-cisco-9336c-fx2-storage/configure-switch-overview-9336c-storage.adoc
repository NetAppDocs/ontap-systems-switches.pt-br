...
summary: Siga este fluxo de trabalho para instalar e configurar os switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T em um ambiente ONTAP. 
---
= Fluxo de trabalho de instalação e configuração para os switches de armazenamento Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar e configurar os switches de storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T em um ambiente ONTAP. Esses switches fazem parte da plataforma Cisco Nexus 9000 e oferecem suporte à conectividade de rede de storage para sistemas ONTAP.
