...
[role="lead"]
Você pode instalar o RCF após configurar o switch Nexus 92300YC pela primeira vez. Você também pode usar este procedimento para atualizar a versão do seu RCF.
