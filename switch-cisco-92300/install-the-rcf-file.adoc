...
summary: 'Instale ou atualize o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 92300YC após a configuração inicial ou quando uma versão mais recente estiver disponível.' 
---
= Instale ou atualize o RCF nos switches de cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 92300YC após a configuração inicial ou atualize sua versão do RCF quando uma versão mais recente estiver disponível.
...
[NOTE]
====
* O procedimento requer o uso de comandos ONTAP e  https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Switches Cisco Nexus série 9000"^]; comandos ONTAP são usados a menos que indicado de outra forma.
* Antes de executar este procedimento, certifique-se de que você tem um backup atual da configuração do switch.
...
. Copie o RCF para a bootflash do switch cs2 usando um dos seguintes protocolos de transferência: FTP, TFTP, SFTP ou SCP. Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado na link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Switches Cisco Nexus série 9000"^].
+
...
+
Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado na link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Switches Cisco Nexus série 9000"^].
...
. Reaplique quaisquer personalizações anteriores à configuração do switch. Consulte link:cabling-considerations-92300.html["Analise as considerações sobre cabeamento e configuração."] para obter detalhes sobre quaisquer outras alterações necessárias.
...
----
. Reinicie o switch cs1. Você faz isso para forçar as LIFs do cluster a retornarem às suas portas originais. Você pode ignorar os eventos de "portas do cluster inativas" relatados nos nós enquanto o switch reinicia.
+
[listing, subs="+quotes"]
----
cs1# *reload*
...
----
====
. Verifique se as LIFs do cluster retornaram à sua porta inicial:
`network interface show -vserver Cluster`
+
.Mostrar exemplo
[%collapsible]
