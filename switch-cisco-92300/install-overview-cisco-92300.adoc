...
[role="lead"]
Os switches Cisco Nexus 92300YC podem ser usados como switches de cluster no seu cluster AFF ou FAS. Os switches de cluster permitem que você construa clusters ONTAP com mais de dois nós.
