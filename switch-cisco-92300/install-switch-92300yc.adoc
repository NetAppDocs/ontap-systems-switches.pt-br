...
* Concluídolink:setup-worksheet-92300yc.html["fichas de trabalho de cablagem"] .
...
* link:required-documentation-92300.html["Documentação necessária do switch e do ONTAP"] .
...
.O que se segue?
Opcionalmente, você podelink:install-switch-netapp-cabinet-92300yc.html["instalar um switch Cisco Nexus 3223C em um gabinete NetApp"] .  Caso contrário, vá paralink:cabling-considerations-92300.html["Revise o cabeamento e a configuração"] .
