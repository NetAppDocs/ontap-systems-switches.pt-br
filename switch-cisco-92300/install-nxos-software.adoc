...
summary: Instale o software NX-OS nos switches de cluster Cisco Nexus 92300YC para prepará-los para a operação em cluster. 
---
= Instale o software NX-OS nos switches de cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o software NX-OS nos switches de cluster Cisco Nexus 92300YC para prepará-los para a operação em cluster. O NX-OS deve ser instalado antes que você possa configurar o switch ou instalar o RCF.
...
* Software Cisco NX-OS aplicável NetApp para seus switches do NetApp Support Site, disponível em  http://mysupport.netapp.com/["meusuporte.netapp.com"]
...
.O que vem a seguir?
Após instalar o software NX-OS, você pode link:install-the-rcf-file.html["instalar o RCF"].
