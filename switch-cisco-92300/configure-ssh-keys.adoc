...
summary: 'O SSH é um requisito para usar o Monitor de Saúde do Switch de Cluster (CSHM) e os recursos de coleta de logs. Para habilitar o SSH nos switches de cluster Cisco 92300YC, primeiro você gera as chaves SSH e depois habilita o SSH.' 
---
