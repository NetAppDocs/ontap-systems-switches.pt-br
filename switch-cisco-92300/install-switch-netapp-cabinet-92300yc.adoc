...
.Antes de começar
* Os requisitos de preparação inicial, o conteúdo do kit e as precauções de segurança nolink:http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexu9000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guia de instalação de hardware do Cisco Nexus 9000 Series"^] .
