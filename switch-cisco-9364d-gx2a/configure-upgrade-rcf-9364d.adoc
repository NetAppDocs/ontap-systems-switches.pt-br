...
summary: 'Você atualiza a versão do Arquivo de Configuração de Referência (RCF) em seus switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 1K ou AFX 2K.' 
---
= Atualize a versão RCF - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você atualiza a versão do Arquivo de Configuração de Referência (RCF) em seus switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 1K ou AFX 2K.


NOTE: Não atualize nem faça downgrade da sua versão do RCF para uma versão não suportada.

.Antes de começar
* Você deve ter lido a página link:configure-install-upgrade-rcf-overview-9364d.html["Visão geral da instalação ou atualização do RCF"].
...
+
Se seus switches estiverem executando o RCF 10.1 ou posterior, você pode link:configure-install-upgrade-rcf-overview-9364d.html#change-port-speed-configuration["alterar a configuração de velocidade da porta"] se necessário.
...
.O que vem a seguir?
Depois de atualizar o RCF em seus switches, você link:configure-verify-ssh-9364d.html["Verifique o SSH para coleta de logs"].
