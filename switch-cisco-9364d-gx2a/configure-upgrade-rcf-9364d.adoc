...
summary: Atualize o RCF nos switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware, uma nova versão do ONTAP ou uma nova versão do NX-OS nos sistemas AFX 1K ou AFX 2K. 
---
= Atualize o RCF no switch Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração de referência (RCF) nos switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware, uma nova versão do ONTAP ou uma nova versão do NX-OS nos sistemas AFX 1K ou AFX 2K.
