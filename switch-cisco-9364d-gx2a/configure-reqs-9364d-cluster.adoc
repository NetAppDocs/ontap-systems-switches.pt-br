...
---
= Requisitos de rede para switches Cisco Nexus 9364D-GX2A
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para instalação e manutenção do switch Cisco Nexus 9364D-GX2A, certifique-se de revisar os requisitos de cabeamento e rede.
