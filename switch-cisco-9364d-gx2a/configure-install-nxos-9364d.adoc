...
summary: Você instala o NX-OS no seu switch Cisco Nexus 9364D-GX2A como parte de uma nova instalação do sistema AFX 1K ou AFX 2K, de uma substituição de switch ou de uma redefinição do switch para as configurações padrão de fábrica. 
---
= Instale o NX-OS - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você instala o NX-OS no seu switch Cisco Nexus 9364D-GX2A como parte de uma nova instalação do sistema AFX 1K ou AFX 2K, de uma substituição de switch ou de uma redefinição do switch para as configurações padrão de fábrica.
