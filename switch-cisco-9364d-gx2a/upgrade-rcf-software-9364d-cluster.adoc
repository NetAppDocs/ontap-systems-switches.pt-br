...
.. Para NX-OS 10.2 e mais recentes, use o `show diff running-config` comando para comparar com o arquivo RCF salvo no bootflash.  Caso contrário, use uma ferramenta de comparação/diferenciação de terceiros.
