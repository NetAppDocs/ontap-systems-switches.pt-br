...
summary: 'A substituição de um switch Nexus 9364d-gx2a com defeito em uma rede de cluster é um procedimento não disruptivo \(NDU\).' 
---
...
** A personalização inicial do interruptor está concluída, conforme detalhado emlink:setup-switch-9364d-cluster.html["Configurar o switch de cluster 9364D-GX2A"] .
+
