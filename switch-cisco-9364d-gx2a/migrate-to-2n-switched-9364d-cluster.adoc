...
summary: Se você tiver um ambiente de cluster sem switch de dois nós existente, poderá migrar para um ambiente de cluster com switch de dois nós usando switches Cisco Nexus 9364d-gx2a para permitir o dimensionamento além de dois nós no cluster. 
---
...
[role="lead"]
Se você tiver um ambiente de cluster _sem switch_ de dois nós existente, poderá migrar para um ambiente de cluster _com switch_ de dois nós usando switches Cisco Nexus 9364D-GX2A.
...
Consulte a link:https://hwu.netapp.com["Hardware Universe"^] para obter informações sobre as portas de cluster para suas plataformas.
