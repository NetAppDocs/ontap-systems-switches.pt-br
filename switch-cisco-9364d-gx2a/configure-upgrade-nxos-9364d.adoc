...
summary: Atualize o NX-OS nos switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware ou a uma nova versão do ONTAP nos sistemas AFX 1K ou AFX 2K. 
---
= Atualize o NX-OS no switch Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o NX-OS nos switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware ou a uma nova versão do ONTAP nos sistemas AFX 1K ou AFX 2K.
