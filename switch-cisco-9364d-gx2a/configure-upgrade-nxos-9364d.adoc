...
summary: Você atualiza o NX-OS em seus switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware ou a uma nova versão do ONTAP em seu sistema AFX 1K ou AFX 2K. 
---
= Atualize o NX-OS - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você atualiza o NX-OS em seus switches Cisco Nexus 9364D-GX2A para oferecer suporte a novo hardware ou a uma nova versão do ONTAP em seu sistema AFX 1K ou AFX 2K.
...
.O que vem a seguir?
Depois de atualizar o NX-OS em seus switches, você atualiza o RCF começando pelo link:configure-install-upgrade-rcf-overview-9364d.html["Instalar ou atualizar a visão geral do RCF"].
