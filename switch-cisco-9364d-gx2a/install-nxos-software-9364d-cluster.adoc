...
summary: Você pode usar este procedimento para instalar ou atualizar o software NX-OS no switch de cluster Nexus 9364d-gx2a. 
---
...
[role="lead"]
Siga este procedimento para instalar ou atualizar o software NX-OS no switch Nexus 9364D-GX2A.
...
* Conclua o procedimento emlink:install-nxos-overview-9364d-cluster.html["Prepare-se para instalar o NX-OS e o RCF."] .
* Um backup atual da configuração do switch está disponível.
* Um cluster totalmente funcional (sem erros nos logs ou problemas semelhantes) está em vigor.
...
. Copie o software NX-OS e as imagens EPLD para o switch Nexus 9364D-GX2A.
+
.Mostrar exemplo
[%collapsible]
====
...
.O que vem a seguir?
Após instalar ou atualizar o software NX-OS, você pode link:install-upgrade-rcf-overview-cluster-9364d.html["instalar ou atualizar o arquivo de configuração de referência (RCF)"].
