...
.O que vem a seguir?
Após instalar ou atualizar o software NX-OS, vocêlink:install-upgrade-rcf-overview-cluster.html["instalar ou atualizar o arquivo de configuração de referência (RCF)"] .
