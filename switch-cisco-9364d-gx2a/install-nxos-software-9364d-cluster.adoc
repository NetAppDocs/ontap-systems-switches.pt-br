...
* Complete o procedimento emlink:install-nxos-overview-9364d-cluster.html["Prepare-se para instalar o NX-os e o RCF"] .
...
.O que se segue?
Depois de instalar ou atualizar o software NX-OS, vocêlink:install-upgrade-rcf-overview-cluster.html["instalar ou atualizar o arquivo de configuração de referência (RCF)"] .
