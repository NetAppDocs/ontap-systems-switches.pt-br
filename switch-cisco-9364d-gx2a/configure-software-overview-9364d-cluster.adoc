...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Seis"]link:reset-switch-9364d.html["Restaure as configurações de fábrica do switch."]
[role="quick-margin-para"]
