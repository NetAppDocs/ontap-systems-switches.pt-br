...
summary: Você instala o NX-OS no seu switch Cisco Nexus 9808 como parte de uma nova instalação do sistema AFX 2K, uma substituição do módulo supervisor ou uma redefinição do switch para as configurações padrão de fábrica. 
---
