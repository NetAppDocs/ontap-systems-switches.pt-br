...
summary: Atualize o NX-OS nos switches Cisco Nexus 9808 para oferecer suporte a novo hardware ou a uma nova versão do ONTAP em sistemas AFX 2K. 
---
= Atualize o NX-OS no switch Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o NX-OS nos switches Cisco Nexus 9808 para oferecer suporte a novo hardware ou a uma nova versão do ONTAP em sistemas AFX 2K.
