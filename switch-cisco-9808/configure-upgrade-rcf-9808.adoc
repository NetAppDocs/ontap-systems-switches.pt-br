...
summary: 'Você atualiza a versão do Arquivo de Configuração de Referência (RCF) em seus switches Cisco Nexus 9808 para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 2K.' 
---
= Atualize a versão do RCF - Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você atualiza a versão do arquivo de configuração de referência (RCF) em seus switches Cisco Nexus 9808 para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 2K.
