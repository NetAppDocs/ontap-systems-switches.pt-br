...
sidebar: sidebar 
keywords: rcf, upgrade, cluster switch, cisco nexus 3232c 
summary: 'Atualize o arquivo de configuração de referência (RCF) nos switches de cluster Cisco Nexus 3232C quando uma versão mais recente estiver disponível.' 
---
= Atualize o RCF nos switches de cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração de referência (RCF) nos switches de cluster Cisco Nexus 3232C quando uma versão mais recente do RCF estiver disponível.
...
+
Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado na link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referência de comandos do Cisco Nexus 3000 Series NX-OS"^].
...
[NOTE]
====
Você pode observar a seguinte saída no console do switch cs1 dependendo da versão do RCF previamente carregada no switch 2020 Nov 17 16:07:18 cs1 %$ VDC-1 %$ %STP-2-UNBLOCK_CONSIST_PORT: Desbloqueando a porta port-channel1 na VLAN0092. Consistência da porta restaurada. 2020 Nov 17 16:07:23 cs1 %$ VDC-1 %$ %STP-2-BLOCK_PVID_PEER: Bloqueando a porta port-channel1 na VLAN0001. VLAN do peer inconsistente. 2020 Nov 17 16:07:23 cs1 %$ VDC-1 %$ %STP-2-BLOCK_PVID_LOCAL: Bloqueando a porta port-channel1 na VLAN0092. VLAN local inconsistente.
