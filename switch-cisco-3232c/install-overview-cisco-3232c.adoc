...
[role="lead"]
Os switches Cisco Nexus 3232C podem ser usados como switches de cluster em seu cluster AFF ou FAS. Os switches de cluster permitem que você construa clusters ONTAP com mais de dois nós.
