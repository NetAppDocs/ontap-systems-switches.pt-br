...
---
= Conclua sua migração de CN1610 switches para 3232C switches
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua as etapas a seguir para finalizar a migração de switches CN1610 para os switches Nexus 3232C.
