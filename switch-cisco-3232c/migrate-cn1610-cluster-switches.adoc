...
.Sobre os exemplos
Os exemplos neste procedimento utilizam quatro nós: Dois nós utilizam quatro portas de interconexão de cluster 10 GbE: e0a, e0b, e0c e e0d.  Os outros dois nós utilizam dois cabos de fibra óptica de interconexão de cluster de 40 GbE: e4a e e4e.  Olink:https://hwu.netapp.com/["_Universo do Hardware_"^] Possui informações sobre os cabos de fibra óptica do cluster em suas plataformas.
