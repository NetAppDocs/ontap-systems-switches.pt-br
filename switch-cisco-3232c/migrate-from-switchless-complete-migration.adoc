...
---
= Conclua sua migração de um cluster sem switch de dois nós para um cluster de dois nós com switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua as seguintes etapas para finalizar a migração de um cluster sem switch de dois nós para um cluster com switches de dois nós em switches Nexus 3232C.
