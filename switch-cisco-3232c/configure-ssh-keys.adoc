...
summary: Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 3232C para suportar CSHM e coleta de logs. 
---
= Verifique a configuração SSH para os switches de cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 3232C para suportar os recursos de Monitoramento de Saúde do Switch Ethernet (CSHM) e coleta de logs.
