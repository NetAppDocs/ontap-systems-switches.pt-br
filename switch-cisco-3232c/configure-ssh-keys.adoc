...
summary: O SSH é um requisito ao usar o monitor de integridade do switch de cluster e os recursos de coleta de logs. Para habilitar o SSH nos switches de cluster Cisco 3232C, primeiro você gera as chaves SSH e depois habilita o SSH. 
---
