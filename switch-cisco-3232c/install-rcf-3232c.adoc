...
summary: 'Instale ou atualize o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 3232C.' 
---
= Instale ou atualize o RCF nos switches de cluster Cisco Nexus 3232C.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Você também pode usar este procedimento para atualizar sua versão do RCF. Consulte o artigo da Knowledge Base link:https://kb.netapp.com/onprem/Switches/Cisco/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["Como limpar a configuração de um switch de interconexão Cisco mantendo a conectividade remota"^] para obter mais informações ao atualizar seu RCF.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Página do switch Ethernet da Cisco"^]Consulte a tabela de compatibilidade de switches para as versões suportadas do ONTAP e do RCF. Observe que pode haver dependências entre a sintaxe de comandos no RCF e a encontrada nas versões do NX-OS.
...
. Copie o RCF para a bootflash do switch cs2 usando um dos seguintes protocolos de transferência: FTP, TFTP, SFTP ou SCP. Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado em link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referência de comandos do Cisco Nexus 3000 Series NX-OS"^]
+
.Mostrar exemplo
[%collapsible]
====
...
----
====
.. Verifique o estado de saúde do switch no cluster (isso pode não mostrar o switch cs2, já que as LIFs não estão localizadas em e0d).
+
.Mostrar exemplo
[%collapsible]
====
...
NOTE: Pode levar até 5 minutos para que os nós do cluster sejam relatados como íntegros.
...
----
====
. Repita as etapas 7 a 23 no switch cs1.
