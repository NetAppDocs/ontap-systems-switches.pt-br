...
summary: Você pode instalar o RCF após configurar o switch Nexus 3232C pela primeira vez. Você também pode usar este procedimento para atualizar sua versão do RCF. 
---
