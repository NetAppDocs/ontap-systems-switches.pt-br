...
summary: Instale o software NX-OS nos switches de cluster Cisco Nexus 3232C para prepará-los para a operação em cluster. 
---
= Instale o software NX-OS nos switches de cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o software NX-OS nos switches de cluster Cisco Nexus 3232C para prepará-los para a operação em cluster.
...
+
Consulte link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notas de versão da atualização EPLD, Release 9.3(11)"^] para obter mais detalhes.
...
----
====
. Repita as etapas 6 a 14 no switch cs1.
