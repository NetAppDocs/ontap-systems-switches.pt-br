...
+
Consulte link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notas de versão da atualização EPLD, versão 9.3(11)"^] para obter mais detalhes.
