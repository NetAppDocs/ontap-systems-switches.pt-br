...
summary: Siga este fluxo de trabalho para instalar o software NX-OS e o RCF nos switches de cluster Cisco Nexus 3232C. 
---
...
[role="lead"]
Siga este fluxo de trabalho para instalar o software NX-OS e o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 3232C.
...
[role="quick-margin-para"]
Faça o download e instale ou atualize o software NX-OS no switch de cluster Cisco 3232C.
