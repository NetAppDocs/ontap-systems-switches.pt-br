...
summary: Migre sistemas FAS22xx de um cluster sem switch com uma única conexão de rede de cluster para um cluster com switches usando os switches de cluster CN1610 da NetApp. 
---
= Migre sistemas FAS22xx para um cluster comutado usando NetApp CN1610 cluster switches
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migre sistemas FAS22xx de um cluster sem switch de dois nós com uma única conexão 10 GbE por controlador para um cluster com switches usando NetApp CN1610 switches de cluster.
