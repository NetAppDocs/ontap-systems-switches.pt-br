...
summary: Substitua um switch de cluster NetApp CN1610 defeituoso. Este é um procedimento não disruptivo. 
---
...
[role="lead"]
Substitua um switch de cluster CN1610 NetApp defeituoso em uma rede de cluster sem interromper a operação do cluster. Este procedimento não disruptivo (NDU) envolve preparar um switch de substituição e migrar as conexões do switch com falha.
