...
----
====
. Verifique se as versões do switch e do ONTAP correspondem na matriz de compatibilidade. Consulte link:https://mysupport.netapp.com/site/info/netapp-cluster-switch["Switches NetApp CN1601 e CN1610"^] para obter detalhes.
