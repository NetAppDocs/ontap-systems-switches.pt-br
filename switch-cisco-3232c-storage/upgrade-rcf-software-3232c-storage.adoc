...
summary: 'Atualize o arquivo de configuração de referência (RCF) nos switches de storage Cisco Nexus 3232C quando uma versão mais recente estiver disponível.' 
---
= Atualize o RCF nos switches de armazenamento Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração de referência (RCF) nos switches de armazenamento Cisco Nexus 3232C quando uma versão mais recente do RCF estiver disponível.
