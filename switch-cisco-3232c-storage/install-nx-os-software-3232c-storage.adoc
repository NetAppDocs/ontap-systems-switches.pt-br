...
summary: Instale ou atualize o software NX-OS nos switches de storage Cisco Nexus 3232C. 
---
= Instale ou atualize o software NX-OS nos switches de storage Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale ou atualize o software NX-OS nos switches de armazenamento Cisco Nexus 3232C para prepará-los para a operação da rede de storage.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Página do switch Ethernet da Cisco"^]. Consulte a tabela de compatibilidade do switch para as versões suportadas do ONTAP e NX-OS.
...
----
====
. Se você estiver atualizando para a versão 9.3(11) do NX-OS, você deve atualizar a imagem EPLD `golden` e reinicializar o switch novamente. Caso contrário, pule para a etapa 12.
+
Veja  https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notas de versão da atualização EPLD, Release 9.3(11)"^] para mais detalhes.
...
----
====
. Se você estiver configurando seu switch pela primeira vez, pule para a etapa 15. Se você estiver atualizando seu switch, prossiga para a próxima etapa.
