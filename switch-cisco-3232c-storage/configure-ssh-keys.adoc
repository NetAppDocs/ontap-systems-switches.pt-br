...
IMPORTANT: Ao habilitar o FIPS, você deve alterar a contagem de bits para 256 no switch usando o comando. `ssh key ecdsa 256 force` .  Ver https://docs.netapp.com/us-en/ontap/networking/configure_network_security_using_federal_information_processing_standards_@fips@.html#enable-fips["Configure a segurança de rede usando FIPS."^] Para obter mais detalhes.
