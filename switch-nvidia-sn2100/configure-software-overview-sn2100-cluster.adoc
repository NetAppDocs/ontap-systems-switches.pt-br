...
summary: Visão geral da configuração de software dos switches NVIDIA SN2100. 
---
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png["Sete"]link:reset-switch-sn2100.html["Restaure as configurações de fábrica do switch."]
[role="quick-margin-para"]
