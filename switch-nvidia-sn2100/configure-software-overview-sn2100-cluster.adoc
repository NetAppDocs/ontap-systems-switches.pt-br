...
summary: Siga este fluxo de trabalho para instalar o Cumulus Linux e o RCF nos switches de cluster NVIDIA SN2100. 
---
= Fluxo de trabalho de instalação de software para switches de cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar o Cumulus Linux e o arquivo de configuração (RCF) nos switches de cluster NVIDIA SN2100.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Um"]link:configure-sn2100-cluster.html["Configure o interruptor"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinco"]link:install-rcf-sn2100-cluster.html["Instale ou atualize o script do Arquivo de Configuração de Referência (RCF)."]
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png["Sete"]link:../switch-cshm/config-overview.html["Configurar CSHM"]
[role="quick-margin-para"]
