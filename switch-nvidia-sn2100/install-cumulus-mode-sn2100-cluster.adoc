...
summary: Instale o Cumulus Linux nos switches de cluster NVIDIA SN2100 quando o switch estiver em execução no modo Cumulus. 
---
= Instale o Cumulus Linux no modo Cumulus nos switches de cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o Cumulus Linux (CL) nos switches de cluster NVIDIA SN2100 quando o switch estiver em execução no modo Cumulus.


NOTE: O sistema operacional Cumulus Linux (CL) pode ser instalado quando o switch está executando Cumulus Linux ou ONIE (consulte link:install-onie-mode-sn2100-cluster.html["Instalar no modo ONIE"]).
...
----
+
Consulte  https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Contas de usuário NVIDIA"^] para mais informações.
...
Consulte  https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Contas de usuário NVIDIA"^] para mais informações.
