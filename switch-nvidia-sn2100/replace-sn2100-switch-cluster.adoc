...
summary: Substitua um switch de cluster NVIDIA SN2100 defeituoso em uma rede de cluster. Este é um procedimento não disruptivo. 
---
...
[role="lead"]
Substitua um switch de cluster NVIDIA SN2100 defeituoso em uma rede de cluster sem interromper a operação do cluster. Este procedimento não disruptivo (NDU) envolve preparar um switch de substituição e migrar as conexões do switch com falha.
