...
====
.O que se segue?
Depois de analisar os requisitos de cabeamento e configuração, você link:install-cable-shelves-sn2100-cluster.html["Conecte os racks NS224 como armazenamento conectado por switch."].
