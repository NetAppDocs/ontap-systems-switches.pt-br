...
|===
Veja o link:https://hwu.netapp.com/Switch/Index["Hardware Universe"^] Para obter mais informações sobre portas de switch.
...
--
====
Consulte o artigo da Base de Conhecimento.link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric_Interconnect_and_Management_Switches/NVIDIA_SN2100_switch_fails_to_connect_using_40_100GbE_copper_cable["O switch SN2100 não consegue se conectar usando cabos de cobre 40/100GbE."^] Para obter mais detalhes.
...
--
====
Veja o link:https://hwu.netapp.com/Switch/Index["Hardware Universe"^]e o artigo da Base de Conhecimento link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Que informações adicionais preciso para instalar meu equipamento que não está no HWU?"^] Para obter mais informações.
