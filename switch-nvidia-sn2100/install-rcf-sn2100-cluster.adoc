...
Há dois scripts RCF disponíveis para aplicativos de cluster e armazenamento. Baixe RCFs de https://mysupport.netapp.com/site/info/nvidia-cluster-switch["aqui"^]. O procedimento para cada um é o mesmo.
