...
summary: Certifique-se de que os seguintes itens estejam disponíveis no switch antes de instalar o script RCF. 
---
= Instale ou atualize o script do Arquivo de Configuração de Referência (RCF).
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
