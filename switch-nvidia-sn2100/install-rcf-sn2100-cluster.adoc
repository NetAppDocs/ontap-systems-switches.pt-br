...
* O Cumulus Linux está instalado.  Veja o https://hwu.netapp.com/Switch/Index["Hardware Universe"^] Para versões compatíveis.
...
| Conjunto | Em portas configuradas para breakout 4x10GbE, uma porta é configurada para breakout 4x25GbE e as outras portas são configuradas para 40/100GbE. Suporta tráfego de cluster/HA compartilhado em portas para nós que usam portas de cluster/HA compartilhadas. Consulte a tabela de plataformas no artigo da Base de Conhecimento. https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/What_AFF_ASA_and_FAS_platforms_use_shared_Cluster_and_HA_Ethernet_ports["Quais plataformas AFF, ASA e FAS usam portas Ethernet de cluster e HA compartilhadas?"^] . Todas as portas também podem ser usadas como portas de cluster dedicadas. 
