...
NOTE: Enquanto `scp` for usado no exemplo, você pode usar o método preferido de transferência de arquivos.
...
NOTE:  `scp`Embora seja usado no exemplo, você pode usar seu método preferido de transferência de arquivos.
