...
NOTE: No passo 3 *Atualizando o arquivo MOTD* acima, o comando `cat /etc/issue` é executado. Isso permite verificar o nome do arquivo RCF, a versão RCF, as portas a usar e outras informações importantes no banner RCF.
