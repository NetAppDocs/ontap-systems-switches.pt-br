...
summary: Siga este fluxo de trabalho para instalar e configurar os switches de cluster NVIDIA SN2100 em um ambiente ONTAP. 
---
= Fluxo de trabalho de instalação e configuração para switches de cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar e configurar os switches de cluster NVIDIA SN2100 em um ambiente ONTAP. O SN2100 é um switch 10/25/40/100 GbE que executa o Cumulus Linux e oferece suporte a clusters ONTAP com mais de dois nós.
