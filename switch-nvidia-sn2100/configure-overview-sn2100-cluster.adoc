...
summary: O switch NVIDIA SN2100 é um switch Ethernet Gigabit Ethernet 10/25/40/100 que executa o sistema operacional Cumulus Linux.  O switch SN2100 serve aplicações de Cluster e Armazenamento no ONTAP 9.10.1 em diferentes pares de switches. 
---
...
[role="lead"]
O NVIDIA SN2100 é um switch de cluster que permite criar clusters ONTAP com mais de dois nós.
