...
====
.O que se segue?
Depois de instalar o Cumulus Linux no modo ONIE, você link:install-rcf-sn2100-cluster.html["Instale o script do Arquivo de Configuração de Referência (RCF)."].
