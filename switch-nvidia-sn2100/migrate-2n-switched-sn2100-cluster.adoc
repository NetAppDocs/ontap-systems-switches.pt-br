...
summary: Se você já possui um ambiente de cluster sem switches com dois nós, pode migrar para um ambiente de cluster com switches com dois nós usando switches NVIDIA SN2100 para permitir a escalabilidade além de dois nós no cluster. 
---
