...
summary: Você pode usar este procedimento para instalar ou atualizar o software NX-OS no switch de cluster Nexus 9332D-GX2B. 
---
...
[role="lead"]
Siga este procedimento para instalar ou atualizar o software NX-OS no switch Nexus 9332D-GX2B.
...
* Conclua o procedimento emlink:install-nxos-overview-9332d-cluster.html["Prepare-se para instalar o NX-OS e o RCF."] .
...
----
. Copie o software NX-OS e as imagens EPLD para o switch Nexus 9332D-GX2B.
+
.Mostrar exemplo
[%collapsible]
====
...
----
====
. Repita as etapas 6 a 13 para instalar o software NX-OS e as imagens EPLD no switch cs1.
...
.O que vem a seguir?
Após instalar ou atualizar o software NX-OS, você pode link:install-upgrade-rcf-overview-cluster-9332d.html["instalar ou atualizar o arquivo de configuração de referência (RCF)"].
