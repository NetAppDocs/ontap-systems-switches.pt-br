...
summary: Instale o NX-OS nos switches Cisco Nexus 9332D-GX2B para novas instalações de sistemas AFX 1K ou AFX 2K, substituições de switches ou restaurações para as configurações de fábrica. 
---
= Instale o NX-OS no switch Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o NX-OS nos switches Cisco Nexus 9332D-GX2B para novas instalações de sistemas AFX 1K ou AFX 2K, substituições de switches ou ao redefinir um switch para as configurações padrão de fábrica.
...
+
** Se o(s) seu(s) switch(es) já possuem a versão atual compatível com a NetApp, você não precisa instalar o NX-OS. Você precisa instalar o RCF. Comece com o link:configure-install-upgrade-rcf-overview-9332d.html["Instalar ou atualizar a visão geral do RCF"].
...
.O que vem a seguir?
Depois de instalar o NX-OS em seus switches, você instala o RCF começando com o link:configure-install-upgrade-rcf-overview-9332d.html["Instalar ou atualizar a visão geral do RCF"].
