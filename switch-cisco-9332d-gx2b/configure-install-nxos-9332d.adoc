...
summary: Você instala o NX-OS no seu switch Cisco Nexus 9332D-GX2B como parte de uma nova instalação do sistema AFX 1K ou AFX 2K, de uma substituição de switch ou de uma redefinição do switch para as configurações padrão de fábrica. 
---
