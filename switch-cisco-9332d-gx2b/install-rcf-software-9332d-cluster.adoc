...
[role="lead"]
Você instala o RCF depois de configurar o switch Nexus 9332D-GX2B pela primeira vez.
...
+
Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado nos  https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Guia de Comandos do Cisco Nexus Série 9000 NX-OS"^] guides.
