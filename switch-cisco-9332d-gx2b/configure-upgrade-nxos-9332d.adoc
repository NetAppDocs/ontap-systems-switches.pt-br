...
Você instala o NX-OS no primeiro switch (cs1) instalando e verificando as novas versões do NX-OS e do EPLD, verificando a integridade de todas as portas no cluster e, em seguida, repete essas etapas no segundo switch (cs2).
