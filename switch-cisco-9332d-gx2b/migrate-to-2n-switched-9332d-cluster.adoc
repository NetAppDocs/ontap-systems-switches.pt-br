...
** Consulte a  https://hwu.netapp.com["Hardware Universe"^] para todas as versões do ONTAP compatíveis.
...
+
Consulte o  https://hwu.netapp.com["Hardware Universe"^] para obter mais informações sobre cabeamento.
