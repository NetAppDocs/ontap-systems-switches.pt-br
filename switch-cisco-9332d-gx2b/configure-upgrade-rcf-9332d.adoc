...
summary: 'Você atualiza a versão do Arquivo de Configuração de Referência (RCF) em seus switches Cisco Nexus 9332D-GX2B para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 1K ou AFX 2K.' 
---
= Atualizar a versão RCF - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você atualiza a versão do Arquivo de Configuração de Referência (RCF) em seus switches Cisco Nexus 9332D-GX2B para oferecer suporte a novo hardware, uma nova versão do ONTAP ou para alinhar com uma nova versão do NX-OS na configuração do seu sistema AFX 1K ou AFX 2K.
