...
summary: O software Cisco NX-OS e os arquivos de configuração de referência devem ser instalados nos switches de cluster Cisco Nexus 9332D-GX2B. 
---
...
.O que vem a seguir?
Depois de se preparar para instalar o software NX-OS e o RCF, você link:install-nxos-software-9332d-cluster.html["instalar ou atualizar o software NX-OS"].
