...
summary: 'O recurso de coleta de logs do monitor de integridade do switch Ethernet (CSHM) é usado para coletar logs de switches de cluster ou de rede de storage no ONTAP.' 
---
...
[role="lead"]
O monitor de integridade do switch Ethernet (CSHM) é responsável por garantir a integridade operacional dos switches de rede e coletar logs do switch para fins de depuração. Este procedimento orienta você no processo de configuração da coleta, solicitação de logs de *Suporte* detalhados e ativação da coleta horária de dados *Periódicos* que são coletados pelo AutoSupport.
