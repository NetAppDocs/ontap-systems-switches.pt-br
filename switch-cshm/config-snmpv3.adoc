...
.Switches Broadcom
--
Configure um nome de usuário SNMPv3 SNMPv3_USER em switches Broadcom BES-53248.

* Para *sem autenticação*:
+
[source, cli]
----
snmp-server user SNMPv3UserNoAuth SNMPv3_USER noauth
----
* Para *MD5/SHA autenticação*:
+
[source, cli]
----
snmp-server user SNMPv3UserAuth SNMPv3_USER [auth-md5|auth-sha]
----
* Para autenticação *MD5/SHA com criptografia AES/DES*:
+
[source, cli]
----
snmp-server user SNMPv3UserAuthEncrypt SNMPv3_USER [auth-md5|auth-sha] [priv-aes128|priv-des]
----
