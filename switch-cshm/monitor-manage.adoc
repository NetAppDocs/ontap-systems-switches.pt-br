...
summary: Adicione, configure ou remova manualmente switches de Ethernet do monitoramento CSHM, ou pause o monitoramento durante a manutenção. 
---
= Gerencie o monitoramento de integridade do switch Ethernet
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
