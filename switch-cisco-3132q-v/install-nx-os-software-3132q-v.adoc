...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switch Ethernet Cisco"^]. Consulte a tabela de compatibilidade do switch para ver as versões suportadas do ONTAP e NX-os.
...
. Copie o software NX-os para o switch Nexus 3132Q-V usando um dos seguintes protocolos de transferência: FTP, TFTP, SFTP ou SCP. Para obter mais informações sobre comandos Cisco, consulte o guia apropriado no https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Guias de referência de comando Cisco Nexus 3000 Series NX-os"^].
+
.Mostrar exemplo
[%collapsible]
====
...
----
====
. Repita os passos 6 a 11 no interrutor CS1.
