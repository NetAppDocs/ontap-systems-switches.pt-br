...
summary: Você pode usar este procedimento para instalar o software NX-OS no switch de cluster Nexus 3132Q-V. 
---
...
[role="lead"]
Siga este procedimento para instalar o software NX-OS no switch de cluster Nexus 3132Q-V.
