...
summary: Instale o software NX-OS nos switches de cluster Cisco Nexus 3132Q-V para prepará-los para a operação em cluster. 
---
= Instale o software NX-OS nos switches de cluster Cisco Nexus 3132Q-V
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o software NX-OS nos switches de cluster Cisco Nexus 3132Q-V para prepará-los para a operação em cluster.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switch Ethernet Cisco"^]. Consulte a tabela de compatibilidade do switch para as versões suportadas do ONTAP e NX-OS.
...
Certifique-se de concluir o procedimento em link:prepare-install-cisco-nexus-3132q.html["Prepare-se para instalar o software NX-OS e o arquivo de configuração de referência"] e depois siga os passos abaixo.
...
. Copie o software NX-OS para o switch Nexus 3132Q-V usando um dos seguintes protocolos de transferência: FTP, TFTP, SFTP ou SCP. Para mais informações sobre os comandos da Cisco, consulte o guia apropriado em link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Referência de comandos do Cisco Nexus 3000 Series NX-OS"^].
+
.Mostrar exemplo
[%collapsible]
====
...
----
====
. Repita os passos 6 a 11 no switch cs1.
...
.O que vem a seguir?
Após instalar o software NX-OS, você pode link:install-upgrade-rcf-overview-3132q-v.html["instalar ou atualizar o arquivo de configuração de referência (RCF)"].
