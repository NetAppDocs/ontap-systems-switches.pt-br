...
---
= Conclua a migração de switches Nexus 5596 para switches Nexus 3132Q-V.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua as etapas a seguir para finalizar a migração de switches Nexus 5596 para switches Nexus 3132Q-V.
