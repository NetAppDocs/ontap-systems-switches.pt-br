...
summary: Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 3132Q-V para suportar CSHM e coleta de logs. 
---
= Verifique a configuração SSH dos switches de cluster Cisco Nexus 3132Q-V
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 3132Q-V para suportar os recursos de monitor de integridade do switch Ethernet (CSHM) e coleta de logs.
