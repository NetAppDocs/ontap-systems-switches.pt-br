...
summary: 'O SSH é um requisito ao usar os recursos do Monitor de integridade do Cluster Switch (CSHM) e coleta de logs. Para ativar o SSH em switches de cluster Cisco 3132Q-V, você gera as chaves SSH primeiro e depois ativa o SSH.' 
---
