...
[role="lead"]
No ONTAP 9.3 e versões posteriores, você pode migrar de um cluster com uma rede de interconexão de cluster comutada para um em que dois nós estão conectados diretamente.
