...
summary: Substitua os switches de cluster Cisco Nexus 3132Q-V por conexões sem switch para ONTAP 9.3 e versões posteriores. 
---
= Substitua os switches de cluster Cisco Nexus 3132Q-V por conexões de cluster sem switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
No ONTAP 9.3 e versões posteriores, migre de um cluster com interconexões comutadas para um em que dois nós estão conectados diretamente, substituindo os switches de cluster Cisco Nexus 3132Q-V por conexões diretas.

[NOTE]
====
NetApp recomenda que você atualize sua versão do ONTAP antes de prosseguir com a operação de cluster sem switch para os switches Cisco Nexus 3132Q-V.
