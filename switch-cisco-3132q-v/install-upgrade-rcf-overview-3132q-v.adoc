...
Para obter detalhes sobre as configurações RCF disponíveis, consultelink:configure-software-overview-3132q-v-cluster.html["Fluxo de trabalho de instalação do software"] .
