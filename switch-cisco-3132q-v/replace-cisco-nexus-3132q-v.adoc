...
summary: Substitua um switch de cluster Cisco Nexus 3132Q-V defeituoso. Este é um procedimento não disruptivo. 
---
...
[role="lead"]
Substitua um switch de cluster Cisco Nexus 3132Q-V defeituoso sem interromper a operação do cluster. Este procedimento não disruptivo (NDU) envolve preparar um switch de substituição e migrar as conexões do switch com falha.
