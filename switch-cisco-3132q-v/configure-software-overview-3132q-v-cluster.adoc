...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Seis"]link:reset-switch-3132q-v.html["Restaure as configurações de fábrica do switch."]
[role="quick-margin-para"]
