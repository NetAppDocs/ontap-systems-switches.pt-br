...
[role="lead"]
Para instalar e configurar o software de um switch Cisco Nexus 3132Q-V e instalar ou atualizar o Arquivo de Configuração de Referência (RCF), siga estes passos:
