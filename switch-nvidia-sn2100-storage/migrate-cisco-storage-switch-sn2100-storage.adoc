...
summary: Migre de switches de armazenamento Cisco antigos para switches de armazenamento NVIDIA SN2100 sem interromper a operação da rede de storage. 
---
...
[role="lead"]
Migre de switches de armazenamento Cisco antigos para switches de armazenamento NVIDIA SN2100 sem interromper a operação da rede de storage.
