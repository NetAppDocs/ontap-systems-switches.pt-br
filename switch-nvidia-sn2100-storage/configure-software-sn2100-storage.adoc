...
summary: Siga este fluxo de trabalho para instalar o Cumulus Linux e o RCF nos switches de storage NVIDIA SN2100. 
---
...
[role="lead"]
Siga este fluxo de trabalho para instalar o Cumulus Linux e o arquivo de configuração (RCF) nos switches de storage NVIDIA SN2100.
