...
summary: Instale o Cumulus Linux nos switches de storage NVIDIA SN2100 quando o switch estiver em modo Cumulus. 
---
= Instale o Cumulus Linux no modo Cumulus nos switches de storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o Cumulus Linux (CL) nos switches de storage NVIDIA SN2100 quando o switch estiver em execução no modo Cumulus.


NOTE: O sistema operacional Cumulus Linux (CL) pode ser instalado quando o switch está executando Cumulus Linux ou ONIE (consulte link:install-onie-mode-sn2100-storage.html["Instalar no modo ONIE"]).
...
* A taxa de transmissão (baud rate) deve ser configurada para 115200 no switch de console serial para acesso ao console do switch NVIDIA SN2100, conforme descrito a seguir:
+
** 115200 baud
** 8 bits de dados
** 1 bit de parada
...
----
+
Consulte o artigo da Knowledge Base link:https://kb.netapp.com/on-prem/Switches/Nvidia-KBs/NTP_Server_configuration_is_not_working_with_NVIDIA_SN2100_Switches["A configuração do servidor NTP não está funcionando com switches NVIDIA SN2100."^] para obter mais detalhes.
...
----
+
Consulte link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Contas de usuário NVIDIA"^] para mais informações.
...
Consulte link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Contas de usuário NVIDIA"^] para mais informações.

--
====
.O que vem a seguir?
Após instalar o Cumulus Linux no modo Cumulus, você podelink:install-rcf-sn2100-storage.html["Instalar ou atualizar o script RCF"] .
