...
NOTE: O sistema operacional Cumulus Linux (CL) pode ser instalado quando o switch estiver executando Cumulus Linux ou ONIE (consultelink:install-onie-mode-sn2100-storage.html["Instalar no modo ONIE"] ).
