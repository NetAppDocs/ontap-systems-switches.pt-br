...
summary: Revise as considerações de cabeamento e configuração dos switches de storage NVIDIA SN2100 antes da implementação. 
---
= Analise as considerações de cabeamento e configuração para os switches de storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Revise as considerações de cabeamento e configuração dos switches de storage NVIDIA SN2100 antes da implementação.
