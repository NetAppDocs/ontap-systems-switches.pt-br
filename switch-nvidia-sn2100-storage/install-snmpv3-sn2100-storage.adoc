...
---
= Configure o SNMPv3 para coleta de logs do switch.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este procedimento para configurar o SNMPv3, que oferece suporte à coleta de logs do switch e ao monitoramento de integridade do switch (SHM).
...
O comando a seguir estabelece o nome de usuário SNMPv3 com o SHM:
