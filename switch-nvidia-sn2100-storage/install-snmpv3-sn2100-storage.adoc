...
summary: Configure o SNMPv3 nos switches de storage NVIDIA SN2100 para habilitar a coleta segura de logs do switch e o monitoramento de integridade. 
---
= Configure o SNMPv3 para switches de storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Configure o SNMPv3 nos switches de storage NVIDIA SN2100 para habilitar a coleta segura e autenticada de logs do switch e o monitor de integridade do switch Ethernet (CSHM).
...
----
====
. Após a conclusão do período de consulta do SHM, verifique se o número de série a ser consultado com o novo usuário SNMPv3 criado é o mesmo detalhado na etapa anterior.
+
