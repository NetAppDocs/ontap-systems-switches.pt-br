...
----
. Verifique se a rede do cluster tem conetividade total usando o comando: `cluster ping-cluster -node node-name`
+
[listing, subs="+quotes"]
----
...
----
. No switch C2, encerre as portas conetadas às portas do cluster dos nós.
+
[listing, subs="+quotes"]
----
(c2)# *configure*
