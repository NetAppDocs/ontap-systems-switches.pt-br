...
summary: Migre de switches de cluster Cisco mais antigos para switches de cluster NVIDIA SN2100 sem interromper a operação do cluster. 
---
...
[role="lead"]
Migre de switches de cluster Cisco para switches de cluster NVIDIA SN2100 sem interromper a operação do cluster. Revise as informações de configuração, conexões de porta e requisitos de cabeamento antes de iniciar a migração.
