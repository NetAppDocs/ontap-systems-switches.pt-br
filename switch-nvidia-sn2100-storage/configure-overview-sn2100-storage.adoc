...
summary: Siga este fluxo de trabalho para instalar e configurar os switches de storage NVIDIA SN2100 em um ambiente ONTAP. 
---
= Fluxo de trabalho de instalação e configuração para switches de storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga este fluxo de trabalho para instalar e configurar os switches de armazenamento NVIDIA SN2100 em um ambiente ONTAP. O switch de armazenamento SN2100 roteia dados entre servidores e arrays de armazenamento que executam ONTAP.

Siga estes passos do fluxo de trabalho para instalar e configurar seus switches SN2100.
