...
summary: Siga este fluxo de trabalho para instalar e configurar os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T em um ambiente ONTAP. 
---
...
[role="lead"]
Siga este fluxo de trabalho para instalar e configurar os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T em um ambiente ONTAP. Esses switches fazem parte da plataforma Cisco Nexus 9000 e suportam clusters ONTAP com mais de dois nós.
