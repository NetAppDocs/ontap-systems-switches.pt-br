...
summary: Migre os switches de cluster NetApp CN1610 para os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T sem interromper a operação do cluster. 
---
= Migre de switches de cluster NetApp CN1610 para switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migre os switches de cluster NetApp CN1610 existentes para os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T sem interromper a operação do cluster.
