...
Para obter detalhes sobre as portas suportadas e suas configurações, consulte o link:https://hwu.netapp.com/["Hardware Universe"^]. Consulte link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Que informações adicionais preciso para instalar meu equipamento que não está no HWU?"^] para obter mais informações sobre os requisitos de instalação do switch.
...
--
====
. [[passo 6]]Altere o nível de privilégio de volta para administrador:
+
`set -privilege admin`
