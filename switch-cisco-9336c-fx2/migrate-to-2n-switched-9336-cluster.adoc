...
summary: Migre um cluster sem switch de dois nós existente para um ambiente de cluster com switches usando os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T. 
---
= Migre para um cluster comutado de dois nós usando os switches de cluster Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migre um cluster sem switch de dois nós existente para um ambiente de cluster com switches usando os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T. Essa migração sem interrupções permite que você expanda o cluster para além de dois nós.
...
** Consulte a link:https://hwu.netapp.com["Hardware Universe"^] para todas as versões do ONTAP compatíveis.
...
+
Consulte o link:https://hwu.netapp.com["Hardware Universe"^] para obter mais informações sobre cabeamento.
...
Consulte a link:https://hwu.netapp.com["Hardware Universe"^] para obter informações sobre as portas de cluster para suas plataformas. Consulte link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Que informações adicionais preciso para instalar meu equipamento que não está no HWU?"^] para obter mais informações sobre os requisitos de instalação do switch.
...
[%collapsible]
====
O exemplo a seguir mostra que todas as LIFs estão ativas no node1 e no node2:
