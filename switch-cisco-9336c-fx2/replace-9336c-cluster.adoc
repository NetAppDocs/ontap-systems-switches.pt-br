...
[role="lead"]
Siga estas etapas para substituir um switch Nexus 9336C-FX2 defeituoso em uma rede de cluster. Este é um procedimento sem interrupções (NDU).
...
----
====
. Verifique se todas as LIFs do cluster podem se comunicar:
+
