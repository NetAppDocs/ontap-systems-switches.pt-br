...
summary: 'Instale o arquivo de configuração de referência (RCF) nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T após a configuração inicial para configurar atribuições de portas, VLANs e configurações de rede.' 
---
= Instale o RCF nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o arquivo de configuração de referência (RCF) nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T após a configuração inicial. O RCF define as atribuições de porta, VLANs e configurações de rede necessárias para a operação do cluster.
...
. Copie o arquivo RCF para a bootflash do switch cs1 usando um dos seguintes protocolos de transferência: FTP, SFTP ou SCP.
+
