...
* Para requisitos de preparação inicial, conteúdo do kit e precauções de segurança, consulte https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guia de Instalação de Hardware da Série Cisco Nexus 9000"^] .
