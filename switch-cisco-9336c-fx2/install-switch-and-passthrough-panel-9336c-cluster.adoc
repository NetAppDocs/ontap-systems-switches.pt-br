...
summary: Instale os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T e um painel de passagem em um NetApp gabinete usando os suportes padrão incluídos com o switch. 
---
= Instale os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T em um gabinete NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale os switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T e um painel de passagem em um NetApp gabinete usando os suportes padrão incluídos com o switch.
...
* Para requisitos de preparação inicial, conteúdo do kit e precauções de segurança, consulte o link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guia de Instalação de Hardware da Série Cisco Nexus 9000"^].
...
+
Neste procedimento, o painel cego é instalado em U40.
...
.O que vem a seguir?
Após instalar os switches no gabinete NetApp , você podelink:setup-switch-9336c-cluster.html["configurar os switches Cisco Nexus 9336C-FX2 e 9336C-FX2-T"] .
