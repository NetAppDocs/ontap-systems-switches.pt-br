...
summary: Siga este fluxo de trabalho para instalar o software NX-OS e o RCF nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T. 
---
...
[role="lead"]
Siga este fluxo de trabalho para instalar o software NX-OS e o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatro"]link:install-upgrade-rcf-overview-cluster-9336c.html["Instale ou atualize o RCF"]
[role="quick-margin-para"]
