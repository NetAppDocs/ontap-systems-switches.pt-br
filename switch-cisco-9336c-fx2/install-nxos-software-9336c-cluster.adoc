...
[role="lead"]
Siga este procedimento para instalar ou atualizar o software NX-os no switch de cluster Nexus 9336C-FX2.
...
.O que se segue?
link:install-upgrade-rcf-overview-cluster.html["Instalar ou atualizar o ficheiro de configuração de referência (RCF)"]
