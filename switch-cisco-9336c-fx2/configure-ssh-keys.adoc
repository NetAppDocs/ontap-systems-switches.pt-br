...
summary: Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 9336C-FX2 para suportar CSHM e coleta de logs. 
---
= Verifique a configuração SSH dos switches de cluster Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique se o SSH e as chaves SSH estão habilitados nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T para suportar os recursos de monitor de integridade do switch Ethernet (CSHM) e coleta de logs.
