...
summary: 'Atualize o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando uma versão mais recente estiver disponível.' 
---
= Atualize o RCF nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Atualize o arquivo de configuração (RCF) nos switches de cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando uma versão mais recente do RCF estiver disponível.
...
. Copie o arquivo RCF para a memória flash de inicialização no switch cs1 usando um dos seguintes protocolos de transferência: FTP, SFTP ou SCP.
+
Para obter mais informações sobre os comandos da Cisco, consulte o guia apropriado na link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Guia de Comandos do Cisco Nexus Série 9000 NX-OS"^].

+
Este exemplo mostra o SFTP sendo usado para copiar um RCF para a bootflash no switch cs1:
...
Enter hostname for the sftp server: *172.22.201.50*
Enter username: *user1*
Trying to connect to sftp server......Connection to Server Established.
SFTP get operation was successful
...
. Execute uma reinicialização do switch cs2.
+
`cs2# *reload*`
...
CAUTION: Se o seu switch 9336C-FX2 não inicializar após a atualização do RCF, consulte o artigo da Knowledge Base da NetApp link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["Cisco 9336C-FX2 Switch falha ao inicializar após a instalação do RCF – variável de inicialização apagada"^] para obter as próximas etapas.
